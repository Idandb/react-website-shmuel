...
const faqs = [
  ...
  },
  {
    ...
    a: 'המחיר נקבע לפי סוג המתכת, הכמות והמשקל. אנו משלמים מחיר הוגן ותחרותי ונותנים הצעת מחיר משתלמת באחריות — חייגו 053-7380382 לקבלת הצעת מחיר מעודכנת.',
  },
  {
    q: 'האם פינוי הגרוטאות בתשלום?',
    a: 'ברוב המקרים אנו רוכשים את המתכות ומבצעים את הפינוי ללא עלות עבורכם. אנו מגיעים עם משאית מנוף לפינוי גרוטאות ופינוי ציוד כבד גם בכמויות גדולות.',
  },
  {
    q: 'באילו אזורים אתם נותנים שירות?',
    a: 'אנו פועלים בפריסה רחבה באזור המרכז, השפלה, הדרום והשרון — וזמינים לפינוי מתכות וגרוטאות בעשרות ערים ויישובים.',
  },
  {
